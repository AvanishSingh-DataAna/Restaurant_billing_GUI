...
def loginWindow():
    titleLabel = Label(window,text="Sixty Two Billing System",font="Arial 40",fg="PaleVioletRed")
    titleLabel.grid(row=0,column=0,columnspan=6, padx=(40,0),pady=(10,0))

    loginLabel = Label(window,text="Admin Login",font="Arial 30", fg="DarkTurquoise")
    loginLabel.grid(row=1, column=2,padx=(50,0),columnspan=2, pady=10)

    usernameLabel = Label(window, text="Username:",font="Arial 20", fg="blue")
    usernameLabel.grid(row=2, column=2,padx=15, pady=5)

    passwordLabel = Label(window, text="Password:",font="Arial 20", fg="blue")
    passwordLabel.grid(row=3, column=2,padx=15, pady=5)

    usernameEntry= Entry(window, textvariable=usernameVar,font="Arial 16", fg="black")
    usernameEntry.grid(row=2, column=3,padx=12,pady=5)

    passwordEntry = Entry (window, textvariable=passwordVar,show="*",font="Arial 16", fg="black")
    passwordEntry.grid(row=3,column=3,padx=12,pady=5)

    loginButton=Button(window, text="Login",width=20, height=2, bg="LightSeaGreen",fg="white",font="Arial 12", command=lambda:adminLogin())
    loginButton.grid(row=4, column=2, columnspan=2)

def mainwindow():
    
    titleLabel = Label(window,text="Sixty Two Billing System",font="Arial 30",fg="PaleVioletRed")
...
def itemAddWindow():
    ...
    titleLabel = Label(window,text="Sixty Two Billing System", width=40,font="Arial 30",fg="PaleVioletRed")
...
def viewAllBills():
    backButton = Button(window, text="Back", width=10, height=2,bg="LightSeaGreen",fg="white",font="Arial 12", command=lambda:readAllData())
    backButton.grid(row=0, column=1)
    titleLabel = Label(window,text="Sixty Two Billing System", width=40,font="Arial 30",fg="PaleVioletRed")
    titleLabel.grid(row=0,column=2,columnspan=4,pady=(10,0))
